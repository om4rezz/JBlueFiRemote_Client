	...
	private void initUI() {
		...
		btn_touch_activity.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				View promptView = layoutInflater.inflate(R.layout.prompt_input,
						null);
						...
						.setPositiveButton("OK",
								new DialogInterface.OnClickListener() {
									public void onClick(DialogInterface dialog,
											int id) {
										Intent i = new Intent(
												"delta.bluefi.remote.TouchActivity");
										Bundle extras = new Bundle();
										extras.putString("IP", filterInput(""
												+ input.getText()));
										// ---attach the Bundle object to the
										// Intent object---
										i.putExtras(extras);
						...
						.setPositiveButton("OK",
								new DialogInterface.OnClickListener() {
									public void onClick(DialogInterface dialog,
											int id) {
										Intent i = new Intent(
												"delta.bluefi.remote.DirectoryActivity");
										Bundle extras = new Bundle();
										extras.putString("IP", filterInput(""
												+ input.getText()));
										// ---attach the Bundle object to the
